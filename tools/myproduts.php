...
if (isset($_GET['category'])) {
    ...
    if (is_array($raw_category)) {
        ...
        if ($clean_category === 'all' || $clean_category === '' || stripos($clean_category, 'array') !== false) {
            $clean_params['category'] = 'all';
        } elseif (is_numeric($clean_category)) {
            $clean_params['category'] = (int)$clean_category;
        } else {
            $clean_params['category'] = 'all';
        }
    }
...
$category_filter = ($category === 'all') ? 'all' : (int)$category;
                                    ...
                                    <div class="product-card-slider group">
                                        <div class="product-image-container-slider relative overflow-hidden rounded-lg bg-gray-100">
                                            ...
                                            <div class="absolute top-3 left-3 flex flex-col gap-2">
                                                ...
                                                <?php endif; ?>
                                                <span class="bestseller-badge-slider">
                                                    🔥 Best Seller
                                                </span>
                                            </div>
                                            ...
                                            <!--  <div class="rating-section-slider ">
                                                <div class="flex items-center gap-1">
                                                    <div class="flex text-yellow-400 text-sm">
                                                        <?php echo str_repeat('★', floor($avg_rating)) . (floor($avg_rating) != $avg_rating ? '½' : '') . str_repeat('☆', 5 - ceil($avg_rating)); ?>
                                                    </div>
                                                    <span class="rating-text-slider">(<?php echo $review_count; ?>)</span>
                                                </div>
                                            </div> -->
    ...
    <div class="container mx-auto px-2 max-w-6xl">
        <div class="flex flex-col lg:flex-row gap-4">
            ...
            <aside class="hidden lg:block lg:w-1/4 flex-shrink-0">
                <div class="bg-white border border-gray-100 rounded-lg shadow-sm p-6 mb-3">
                            ...
                            <li>
                                <a href="products.php?category=<?php echo $cat['category_id']; ?>"
                                    ...
                                    <?php echo ($category == $cat['category_id']) ?
                                        ...
                                        'text-gray-700 hover:bg-purple-100'; ?>">
                                    <?php echo $cat['category_name']; ?>
                                    <span class="float-right text-gray-500 text-xs py-1 px-2 bg-gray-100 rounded-full">
                                        <?php echo $functions->getProductCountByCategory($cat['category_id']); ?>
                                    </span>
                                </a>
                            </li>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 mb-3 border border-gray-100">
                            ...
                            ?>
                                <div class="swiper-slide">
                                    <div class="flex space-x-3 p-2 rounded-lg hover:bg-gray-50 transition">
                                        <a href="product.php?id=<?php echo $product['product_id']; ?>" class="flex-shrink-0">
                                            <img src="<?php echo $functions->getProductImage($product['main_image']); ?>"
                                                alt="<?php echo $productNameSafe; ?>"
            ...
            <main class="w-full lg:w-3/4">
                ...
                <div class="bg-white rounded-lg shadow-sm p-4 md:p-6 mb-2">
                ...
                <div class="bg-white rounded-lg shadow-sm p-4 mb-2">
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => 'newest'])); ?>"
                            class="px-3 py-1 text-sm rounded-full <?php echo $sort === 'newest' ? 'bg-purple-100 text-purple-600' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'; ?>">
                            Newest
                        </a>
                        <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => 'popular'])); ?>"
                            class="px-3 py-1 text-sm rounded-full <?php echo $sort === 'popular' ? 'bg-purple-100 text-purple-600' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'; ?>">
                            Popular
                        </a>
                        <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => 'featured'])); ?>"
                            class="px-3 py-1 text-sm rounded-full <?php echo $sort === 'featured' ? 'bg-purple-100 text-purple-600' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'; ?>">
                            Featured
                        </a>
                        <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => 'price_low'])); ?>"
                            class="px-3 py-1 text-sm rounded-full <?php echo $sort === 'price_low' ? 'bg-purple-100 text-purple-600' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'; ?>">
                            Price: L-High
                        </a>
                        <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => 'price_high'])); ?>"
                            class="px-3 py-1 text-sm rounded-full <?php echo $sort === 'price_high' ? 'bg-purple-100 text-purple-600' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'; ?>">
                            Price: H-Low
                        </a>
                        <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => 'discounted'])); ?>"
                            class="px-3 py-1 text-sm rounded-full <?php echo $sort === 'discounted' ? 'bg-purple-100 text-purple-600' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'; ?>">
                            Discounted
                        </a>
                ...
                <div class="bg-white rounded-lg shadow-sm p-1 md:p-4 mb-3">
                    ...
                    <?php if (count($products) > 0): ?>
                        ...
                        <div id="grid-view" class="products-view">
                            <div class="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-5 gap-2 mb-4">
                                ...
                                ?>
                                    <div class="product-card bg-white rounded-lg overflow-hidden  group flex flex-col h-full">
                                        <div class="product-image-container-slider relative overflow-hidden rounded-lg bg-gray-100">

                                            <!-- Product Badges - Update this section in your main products grid -->
                                        ...
                                        <div class="p-2 flex flex-col flex-grow">
                                            ...
                                            <a href="product.php?id=<?php echo $product['product_id']; ?>" class="block flex-grow">
                                                <h3 class="text-gray-800 text-sm leading-tight line-clamp-2 hover:text-purple-600 transition">
                                                    <?php echo strlen($productNameSafe) > 15 ? substr($productNameSafe, 0, 15) . '...' : $productNameSafe; ?>
                                                </h3>
                                            </a>

                                            <!-- Added Description to Grid View (Hidden on Mobile) -->
                                            <!-- <p class="product-description text-gray-500 text-xs line-clamp-2 hidden sm:block">
                                            ...
                                            <div class="mt-auto ">
                                                <div class="flex items-center justify-between">
                                                    <div class="w-full sm:w-auto">
                                                        <?php if ($product['discount'] > 0): ?>
                                                            <span class="text-xs md:text-base lg:text-base font-bold text-purple-600 md:text-gray-600 block">
                                                                <?php echo $functions->formatPrice($functions->calculateDiscountedPrice($product['price'], $product['discount'])); ?>
                                                            </span>
                                                            <span class="text-xs font-semibold text-gray-500 line-through">
                                                                <?php echo $functions->formatPrice($product['price']); ?>
                                                            </span>

                                                        <?php else: ?>

                                                            <span class="text-xs md:text-base lg:text-base font-bold text-purple-600 md:text-gray-600">
                                                                <?php echo $functions->formatPrice($product['price']); ?>
                                                            </span><br />
                                                            <span class="text-xs font-semibold text-green-500 bg-green-50 p-1 rounded-lg">
                                                                Best Price
                                                            </span>
                                                        <?php endif; ?>
                                                    </div>
                                                ...
                                                <div class="flex-grow">
                                                    ...
                                                    <div class="flex items-center mb-2">
                                                        <div class="text-yellow-400 text-xs">
                                                            <?php echo str_repeat('★', round($functions->getAverageRating($product['product_id']))) . str_repeat('☆', 5 - round($functions->getAverageRating($product['product_id']))); ?>
                                                        </div>
                                                        <span class="text-xs text-gray-500 ml-1">
                                                            (<?php echo $functions->getProductReviews($product['product_id'], 1) ? count($functions->getProductReviews($product['product_id'], 1)) : '0'; ?> reviews)
                                                        </span>
                                                    </div>
                                ...
                                <nav class="flex items-center space-x-2">
                                    <?php if ($page > 1): ?>
                                        <a href="?<?php echo http_build_query(array_merge($_GET, ['page' => $page - 1])); ?>"
                                            class="px-3 md:px-4 py-2 bg-white border border-gray-300 rounded-md hover:bg-gray-50 transition text-sm md:text-base">
                                            Previous
                                        </a>
                                    <?php endif; ?>
                                    ...
                                    ?>
                                        <a href="?<?php echo http_build_query(array_merge($_GET, ['page' => $i])); ?>"
                                            class="px-3 md:px-4 py-2 <?php echo $i == $page ? 'bg-purple-600 text-white' : 'bg-white border border-gray-300 hover:bg-gray-50'; ?> rounded-full transition text-sm md:text-base">
                                            <?php echo $i; ?>
                                        </a>
                                    <?php } ?>
